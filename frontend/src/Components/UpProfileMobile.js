...
import styles from'../CSS/UpProfileMobile.module.css';

const UpProfileMobile = ({content, id, leave, tp, sub}) => {
    const zgl = 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSxFd_W1I9sAJYUNAot1bna0r0I1FyXBAq_7w&usqp=CAU';
    const [imageSrc, setImageSrc] = useState(`http://d-art.space:8080/avas/${id}`);
    const handleError = () => {
        setImageSrc(zgl);
      };
    return (
...
export default UpProfileMobile;